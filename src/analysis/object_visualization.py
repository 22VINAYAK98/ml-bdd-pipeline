...
class ObjectVisualization:
    ...
    def plot_class_distribution(self):
        ...
        plt.title(
            "BDD100K Object Class Distribution"
        )
    ...
    def plot_bbox_area_distribution(self):
        ...
        plt.savefig(
            "outputs/bbox_area_distribution.png"
        )
    ...
    def plot_occlusion_distribution(self):
        ...
        plt.title(
            "Object Occlusion Distribution"
        )

        plt.savefig(
            "outputs/occlusion_distribution.png"
        )
    ...
    def plot_class_distribution_by_timeofday(self):
        ...
        plt.savefig(
            "outputs/timeofday_class_distribution.png"
        )
    ...
    def plot_vru_perception_risk_analysis(self):
        ...
        plt.savefig(
            "outputs/vru_perception_risk_analysis.png"
        )
