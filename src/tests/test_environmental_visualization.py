...
from src.analysis.environmental_analysis import EnvironmentalAnalyzer
from src.analysis.environmental_visualization import EnvironmentalVisualization
...
def main():
    ...
    analysis_results = EnvironmentalAnalyzer(dataset.records).run()

    visualizer = EnvironmentalVisualization(analysis_results)

    visualizer.run()

    print("Environmental visualization completed.")
