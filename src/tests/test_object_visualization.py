...
from src.analysis.object_analysis import ObjectAnalysisPipeline
from src.analysis.object_visualization import ObjectVisualization
...
def main():
    ...
    analysis_results = ObjectAnalysisPipeline(dataset.records).run()

    visualizer = ObjectVisualization(analysis_results)

    visualizer.run()

    print("Object visualization completed.")
